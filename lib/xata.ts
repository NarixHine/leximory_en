...
const tables = [
  {
    ...
    columns: [
      ...
      { name: "collaborators", type: "multiple" },
      { name: "owner", type: "string", notNull: true, defaultValue: "" },
      { name: "viewers", type: "multiple" },
  ...
  },
  {
    name: "applications",
    columns: [
      { name: "applicant", type: "string", notNull: true, defaultValue: "" },
      { name: "lib", type: "link", link: { table: "libraries" } },
      { name: "status", type: "int", notNull: true, defaultValue: "0" },
      { name: "access", type: "string", notNull: true, defaultValue: "read" },
